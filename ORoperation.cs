...
namespace ISA_Decoder_16Bit {
    /// <summary>
    /// two operand operation that ors together the two operands and stores the value into operand1 (a register
    /// </summary>
    class ORoperation: Operation {
        string verb = "Or";                    // The main verb used for the message
